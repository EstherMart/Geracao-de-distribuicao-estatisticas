public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Estatisticas<DistribuicaoUniforme> estatisticasUniforme = new
        // Estatisticas<>(distribuicaoUniforme);
        Estatisticas<DistribuicaoExponencial> estatisticasExponencial = new Estatisticas<>(distribuicaoExponencial);
        // Estatisticas<DistribuicaoPoisson> estatisticasPoisson = new
        // Estatisticas<>(distribuicaoPoisson);
