...
public class JanelaPrincipal {
    public static JFrame CriarJanelaPrincipal(double[] valoresArray1, double[] valoresArray2, double[] valoresArray3, double[] valoresArray4) {
        GraficoDistribuicao grafico1 = new GraficoDistribuicao("Distribuição Normal 1", valoresArray1);
        GraficoDistribuicao grafico2 = new GraficoDistribuicao("Distribuição Normal 2", valoresArray2);
        GraficoDistribuicao grafico3 = new GraficoDistribuicao("Distribuição Normal 3", valoresArray3);
        GraficoDistribuicao grafico4 = new GraficoDistribuicao("Distribuição Normal 4", valoresArray4);
